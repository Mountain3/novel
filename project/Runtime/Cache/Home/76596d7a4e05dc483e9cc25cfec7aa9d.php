...
<head>
    ...
    <meta name="description" content="纵横中文网,最热门的免费小说网站,提供玄幻小说、网 游小说、言情小说、穿越小说、都市小说等免费小说在线阅读与下载。大神作品齐聚纵横,最新章节每日更新。"/>
    <link rel="stylesheet" type="text/css" href="/project/Public/Assets/css/passport.css" />
    <link rel="stylesheet" type="text/css" href="/project/Public/Assets/css/login_style.css">
    <script type="text/javascript" src="/project/Public/Assets/js/jquery.min.js"></script>
    <script type="text/javascript" src="/project/Public/Assets/js/lib.js"></script>
    <script type="text/javascript" src="/project/Public/Assets/js/passport0901.js"></script>
</head>
<body>
    <div class="wrap pass_header">
        <div class="pass_logo">
            <a href="http://www.zongheng.com/"><img src="/project/Public/Assets/img/zh_logo.png" /></a>
        </div>
    </div>
    <div class="passbg">
        <div class="wrap">
            <div class="pass_ad">
    		<a href="http://www.zongheng.com/" title="" target="_blank"><img src="/project/Public/Assets/img/1440489133196.jpg" width="560" height="410"></a>
            </div>
            <div class="login box">	
        ...
        <div class="login-wrap">
            <div class="login-html">
                ...
                <div class="login-form">
                    ...
                    <form action="<?php echo U('doRegister');?>" method='post' name='reg'>
                        <div class="group">
                            <label for="user" class="label">用户名</label>
                            <td>
                                <input id="user" type="text" class="input" name='UserName'>
                        ...
                        <div class="group">
                            ...
                            <td>
                                <input id="pass" type="password" class="input" data-type="password" name='CheckPassWord' >
                            </td>
                            <td id='RePassInfo'></td>
                        </div>
                        <div class="group">
                            ...
                            <div class='verify'>
                                <td>
                                   <input id="pass" type="text" class="input1" name='UserPhone'>
                                    <input type="submit" class="input2" value="发送验证码"> 
                                </td>
                               <td id='PhoneInfo'></td>  
                            </div>
                        </div>
                        <div class="group">
                            ...
                            <input id="pass" type="text" class="input" name='PhoneVerify'>
                        </div>
                        <div class="group">
                        ...
                        <div class="hr"></div>
                        <div class="foot-lnk">
                            <label for="tab-1" class='already'>已有账号</a>
                        </div>
                    </form>
                    </div>
                </div>
...
<div class="wrap foot">
    ...
    <p>京ICP证：080527号 《网络文化经营许可证》 京ICP备11009265号 京网文[2015]2368-459号 京公网安备110105005190号</p>
    <p>作者发布作品时，请遵守国家互联网信息管理办法规定。本站所收录作品、社区话题、书库评论均属其个人行为，不代表本站立场。</p>
    <em class="l_logo"></em>
</div>
<!-- 页尾 结束 -->
<div style="display:none"><script type="text/javascript" src="/project/Public/Assets/js/tongji.js"></script></div>
</body>
</html>